            ...
            <div className="flex items-start">
              <div className="flex items-center h-5">
                <input
                  ...
                  onChange={(e) => setEnableCalendarSync(e.target.checked)}
                  disabled={loading || success || googleLoading}
                  className="w-4 h-4 text-blue-600 border-gray-300 rounded focus:ring-blue-500 focus:ring-2"
                />
              </div>
              <div className="ml-3 flex-1">
                <label htmlFor="calendar-sync" className="text-sm font-medium text-gray-700 cursor-pointer">
                  ...
                  <p className="text-xs text-gray-600">
                    Allow GetSetTime to see, edit, share, and manage your Google Calendar events. This helps prevent double bookings and keeps your calendar up to date.
                  </p>
                </label>
              </div>
            </div>
