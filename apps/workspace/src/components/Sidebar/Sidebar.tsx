...
export default function Sidebar({ isOpen }: SidebarProps) {
  ...
  useEffect(() => {
    if (pathname === "/departments" || pathname === "/services") {
      ...
      setActiveMenu(pathname === "/departments" ? "departments" : "services");
    } else if (pathname === "/team-members") {
      setActiveMenu("team-members");
        ...
        <nav className="space-y-1">
          ...
          <div>
            <button
              ...
              className={`group w-full flex items-center justify-between px-3 py-2 text-sm font-medium rounded-md ${ activeMenu === "departments" ? "bg-blue-50 text-blue-600" : "text-gray-700 hover:bg-gray-50" }`}
            >
          ...
          <Link href="/team-members" className={`group flex items-center px-3 py-2 text-sm font-medium rounded-md ${ activeMenu === "team-members" ? "bg-blue-50 text-blue-600" : "text-gray-700 hover:bg-gray-50" }`} onClick={() => setActiveMenu("team-members")}>
